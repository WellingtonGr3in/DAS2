...
Banco de dados relacional de de facil aprendizagem

## Consequências

Postiva: Modelo Relacional adequado para o caso


## Alternativas rejeitadas

Sql Sever equipe sem conehcimento

## Links    
    
[Azure SQL Database](https://learn.microsoft.com/pt-br/azure/azure-sql/database/sql-database-paas-overview) ·
